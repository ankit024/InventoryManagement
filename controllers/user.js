...
exports.getLogin = (req, res) => {
  ...
  res.render('account/login', {
    title: 'Login',
    content: 'Login-page',
    randomNumber: global.someRandomNumber
  });
};
...
// exports.getExpressionTab = (req, res) => {
//   res.render('account/expressionAnalysis', {
//     title: 'ExpressionAnalysis',
//     content: 'expression-page'
//   });
// };
exports.getThemeTab = (req, res) => {
  res.render('account/themeAnalysis', {
    title: 'ThemeAnalysis',
    content: 'theme-page'
  });
};
// exports.getSentimentTab = (req, res) => {
//   res.render('account/sentimentAnalysis', {
//     title: 'SentimentAnalysis',
//     content: 'sentiment-page'
//   });
// };
// exports.getCallDataTab = (req, res) => {
//   res.render('account/callAnalysis', {
//     title: 'CallAnalysis',
...
//   });
// };
// exports.getTeamleaderPage = (req, res) => {
//   res.render('account/teamleader', {
//     title: 'teamleader',
//     content: 'teamleader-page'
//   });
// };
