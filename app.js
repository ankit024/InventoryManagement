...
const foodCategoryController = require('./controllers/foodcategory');
const managerFormController = require('./controllers/managerForm');
/**
...
// app.get('/expressionAnalysis', passportConfig.isAuthenticated, userController.getExpressionTab);
// app.get('/callAnalysis', passportConfig.isAuthenticated, userController.getCallDataTab);
// app.get('/sentimentAnalysis', passportConfig.isAuthenticated, userController.getSentimentTab);
app.get('/themeAnalysis', passportConfig.isAuthenticated, userController.getThemeTab);
// app.get('/upload', passportConfig.isAuthenticated, userController.getUploadPage);
// app.get('/teamleader', passportConfig.isAuthenticated, userController.getTeamleaderPage);
app.get('/dashboard', passportConfig.isAuthenticated, userController.getDashboardPage);

app.post('/foodCategories', passportConfig.isAuthenticated, foodCategoryController.getFoodCategoryItem);
app.post('/addRequirement', passportConfig.isAuthenticated, managerFormController.getManagerFromData);
app.post('/addRequirementForVendor1', passportConfig.isAuthenticated, managerFormController.getVendor1FromData);
app.post('/addRequirementForVendor2', passportConfig.isAuthenticated, managerFormController.getVendor2FromData);
app.post('/getItemName', passportConfig.isAuthenticated, managerFormController.getFoodItemName);
app.post('/getInventoryItem', passportConfig.isAuthenticated, managerFormController.getInventoryItemsData);
...
app.listen(app.get('port'), () => {
  ...
  console.log(' ');
  console.log('------------------------------------------');
  console.log('App is running with following parameters:');
