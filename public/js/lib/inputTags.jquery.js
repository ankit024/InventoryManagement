(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            ...
            minLength: 'Warning, your tag must have at least 2 characters.',
            maxLength: 'Be careful, your tag must not exceed 30 characters.',
            max: 'Warning, the number of tags must not exceed 4',
